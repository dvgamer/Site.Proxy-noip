  ...
  <tr>
    <td valign="top" width="390">
      ...
      <label><strong>Request Manga URL :</strong><br />
        <input type="text" id="urlrequest" name="url_manga" size="65" maxlength="100" />
      ...
      <center><fieldset style="width:70%; text-align:left;">
        ...
        <div id="list-th">
         <ul>
          ...
          <li id="cartooniverse">cartooniverse.co.uk</li>
          <li id="thaimangaclub">thaimangaclub.blogspot.com</li>
         </ul>  
         </div> 
        </fieldset></center><br />
      <center><fieldset style="width:70%; text-align:left;">
        ...
        <div id="list-en">
         <ul>
          <li id="unixmanga">unixmanga.com</li>

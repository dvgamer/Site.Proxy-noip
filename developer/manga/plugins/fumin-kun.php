<?php
//$_GET['url'] = 'http://fumin-kun.blogspot.com/2011/02/idolmster-break-05.html';
//$_GET['mangaurl'] = 2;
...
{	
	...
	case 'image';
		$pages = file_get_contents($_GET['url']);
		$img = explode("<div class='art-PostContent'>", $pages);
		$img = explode("<div class='cleared'></div>", $img[1]);		
